...
public:
	...
	*//******************************************************************/
	...
	\return
		The current health.
	*//******************************************************************/
	HealthType GetCurrHealth() const;
	...
	*//******************************************************************/
	void AddHealth(HealthType amount);
	...
	*//******************************************************************/
	void TakeDamage(HealthType amount, Vec3 direction = Vec3{ 0 });
	...
	*//******************************************************************/
	void SetHealth(HealthType newValue);
