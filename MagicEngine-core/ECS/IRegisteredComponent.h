...
#if __has_include("Editor/EditorHistory.h")
	#include "Editor/EditorHistory.h"
	#define HAS_EDITOR_HISTORY
#endif
#if __has_include("Editor/IHiddenComponent.h")
	#include "Editor/IHiddenComponent.h"
	#define HAS_HIDDEN_COMPONENT
#endif
...
template<typename CompType>
void IRegisteredComponent<CompType>::SaveHistory_CompAdd([[maybe_unused]] ecs::EntityHandle entity)
{
#ifdef HAS_EDITOR_HISTORY
	ST<History>::Get()->OneEvent(HistoryEvent_CompAdd<CompType>{ entity });
#endif
}

template<typename CompType>
void IRegisteredComponent<CompType>::SaveHistory_CompRemove([[maybe_unused]] ecs::EntityHandle entity, [[maybe_unused]] const void* compPtr)
{
#ifdef HAS_EDITOR_HISTORY
