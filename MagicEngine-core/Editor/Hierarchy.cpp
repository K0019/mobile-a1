...
namespace editor {
    ...
    Hierarchy::Hierarchy()
        : WindowBase{ ICON_FA_SITEMAP" Hierarchy", gui::Vec2{ 200.0f, 800.0f } }
    ...
    void Hierarchy::DrawContainer(int id)
    {
        // ImGui window with custom styling for better visual hierarchy
        gui::SetStyleVar windowPadding{ gui::FLAG_STYLE_VAR::WINDOW_PADDING, gui::Vec2{ 8, 8 } };
        gui::SetStyleColor headerColor{ gui::FLAG_STYLE_COLOR::HEADER, gui::Vec4{ 0.2f, 0.4f, 0.6f, 0.6f } };
        gui::SetStyleColor headerHoveredColor{ gui::FLAG_STYLE_COLOR::HEADER_HOVERED, gui::Vec4{ 0.3f, 0.5f, 0.7f, 0.7f } };
        gui::SetStyleColor headerActiveColor{ gui::FLAG_STYLE_COLOR::HEADER_ACTIVE, gui::Vec4{ 0.35f, 0.55f, 0.75f, 0.8f } };

        WindowBase::DrawContainer(id);
    }

    void Hierarchy::DrawWindow()
    {
