...
namespace compiler
{
    ...
    void MeshOptimizer::generateTangentsUnwelded(std::vector<Vertex>& unweldedVertices)
    {
        ...
        { 
            //LOG_WARNING("Failed to generate tangents using mikktspace"); 
        }
    }
    ...
    vec4 MeshOptimizer::calculateBounds(std::span<const Vertex> vertices, const std::vector<MorphTargetData>* morphTargets)
    {
