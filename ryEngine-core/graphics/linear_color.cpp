...
void LinearColorSystem::CreateToneMappingPipeline()
{
  ...
  // hardcode for now to avoid dependency on filesystem
    ...
    m_vertToneMap = m_context.createShaderModule({codeVS,
      vk::ShaderStage::Vert,
      "Shader Module: Tonemap (vert)"});
  m_fragToneMap = m_context.createShaderModule({codeFS,
      vk::ShaderStage::Frag,
      "Shader Module: Tonemap (frag)"});
