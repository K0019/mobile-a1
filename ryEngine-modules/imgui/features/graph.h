...
class LinearGraph
{
  public:
    ...
    void renderGraph(uint32_t x, uint32_t y, uint32_t width, uint32_t height, const glm::vec4& color = glm::vec4(1.0)) const
    {
      PROFILER_FUNCTION();
      ...
      ImGui::Begin(name_,
                   nullptr,
                   ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoNav | ImGuiWindowFlags_NoBackground | // Keep background transparent
