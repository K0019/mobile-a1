...
namespace AssetLoading
{
  ...
  MeshHandle AssetSystem::createMesh(const ProcessedMesh& mesh)
  {
  ...
  MaterialHandle AssetSystem::createMaterial(const ProcessedMaterial& material)
  {
  ...
  TextureHandle AssetSystem::createTexture(const ProcessedTexture& texture)
  {
  ...
  std::vector<MeshHandle> AssetSystem::createMeshBatch(const std::vector<ProcessedMesh>& meshes)
  {
  ...
  std::vector<MaterialHandle> AssetSystem::createMaterialBatch(const std::vector<ProcessedMaterial>& materials)
  {
  ...
  std::vector<TextureHandle> AssetSystem::createTextureBatch(const std::vector<ProcessedTexture>& textures)
  {
  ...
  const MeshGPUData* AssetSystem::getMesh(MeshHandle handle) const
  {
    return m_meshPool.getHotData(handle);
  }

  uint32_t AssetSystem::getMaterialIndex(MaterialHandle handle) const
  {
    const auto* hot = m_materialPool.getHotData(handle);
    return hot ? hot->materialOffset / sizeof(MaterialData) : 0;
  }

  uint32_t AssetSystem::getTextureBindlessIndex(TextureHandle handle) const
  {
    const auto* hot = m_texturePool.getHotData(handle);
    return hot ? hot->bindlessIndex : 0;
  }

  const Material* AssetSystem::getMaterialCPU(MaterialHandle handle) const
  {
  ...
  void AssetSystem::freeMesh(MeshHandle handle)
  {
  ...
  void AssetSystem::freeMaterial(MaterialHandle handle)
  {
  ...
  void AssetSystem::freeTexture(TextureHandle handle)
  {
  ...
  MaterialData AssetSystem::generateMaterialDataWithTextures_nolock(const Material& material)
  {
    MaterialData data;
  ...
  uint32_t AssetSystem::resolveTextureIndex_nolock(const MaterialTexture& matTex)
  {
  ...
  void AssetSystem::updateMaterialTextureDependencies_nolock(MaterialHandle materialHandle, const ProcessedMaterial& material)
  {
  ...
  void AssetSystem::resolveWaitingMaterials_nolock(const std::string& textureCacheKey)
  {
  ...
  void AssetSystem::uploadMeshBatch(const std::vector<PendingMeshUpload>& meshes)
  {
  ...
  void AssetSystem::uploadMaterialBatch(std::vector<PendingMaterialUpload>& materials)
  {
    auto& gpuBuffers = m_context->renderer->getGPUBuffers();
  ...
  void AssetSystem::uploadContiguousBatches(const Container& items, vk::BufferHandle targetBuffer, AllocSelector&& allocSelector, DataSelector&& dataSelector)
  {
    if (items.empty())
      return;
  ...
  void AssetSystem::deduplicateMaterialUploads(std::vector<PendingMaterialUpload>& materials)
  {
    if (materials.size() <= 1)
      return;
  ...
  std::string AssetSystem::generateMeshCacheKey(const ProcessedMesh& mesh)
  {
  ...
  std::string AssetSystem::generateMaterialCacheKey(const ProcessedMaterial& material)
  {
  ...
  std::string AssetSystem::generateTextureCacheKey(const ProcessedTexture& texture)
  {
