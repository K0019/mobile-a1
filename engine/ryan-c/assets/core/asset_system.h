...
namespace AssetLoading
{
  class AssetSystem
  {
    ...
    private:
      ...
      AssetPool<MaterialAsset> m_materialPool;
      AssetPool<TextureAsset> m_texturePool;
      ...
      template <typename T>
      std::vector<T> createAssetBatch(const std::vector<typename T::ProcessedType>& assets, T (AssetSystem::*createFunc)(const typename T::ProcessedType&));
