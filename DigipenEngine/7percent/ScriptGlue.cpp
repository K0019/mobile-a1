...
struct DummyTransform
{
	...
	\return
		None
	*//******************************************************************/
	DummyTransform(Transform::Vec p, Transform::Vec lp, Transform::Vec s, Transform::Vec ls, Transform::Vec r, Transform::Vec lr, uint64_t id)
		: position{ p }
		, localPosition{ lp }
		, scale{ s }
		, localScale{ ls }
...
*//******************************************************************/
	static void MoveRight(uint64_t entityHandle, float unitsMoved)
	{
		...
		reinterpret_cast<ecs::EntityHandle>(entityHandle)->GetTransform().AddLocalPosition(Vec3(unitsMoved, 0, 0));
	}
...
#pragma region TransformComponent
	...
	*//******************************************************************/
	static void GetTransform(uint64_t entityHandle, DummyTransform* out)
	{
		...
		*out = DummyTransform(t.GetWorldPosition(), t.GetLocalPosition(),t.GetWorldScale(), t.GetLocalScale(),t.GetWorldRotation(), t.GetLocalRotation(), entityHandle);
	}
	...
	*//******************************************************************/
	...
	\return
		None.
	*//******************************************************************/
	static void SetTransformLocalPos(uint64_t entityHandle, Transform::Vec* value)
	{
	...
	\return
		None.
	*//******************************************************************/
	static void GetTransformLocalPos(uint64_t entityHandle, Transform::Vec* target)
	{
		*target = reinterpret_cast<ecs::EntityHandle>(entityHandle)->GetTransform().GetLocalPosition();
	}
	...
	\return
		None.
	*//******************************************************************/
	static void SetTransformWorldPos(uint64_t entityHandle, Transform::Vec* value)
	{
	...
	\return
		None.
	*//******************************************************************/
	static void GetTransformWorldPos(uint64_t entityHandle, Transform::Vec* target)
	{
		*target = reinterpret_cast<ecs::EntityHandle>(entityHandle)->GetTransform().GetWorldPosition();
	}
	...
	\return
		None.
	*//******************************************************************/
	static void SetTransformLocalScale(uint64_t entityHandle, Transform::Vec* value)
	{
	...
	\return
		None.
	*//******************************************************************/
	static void GetTransformLocalScale(uint64_t entityHandle, Transform::Vec* target)
	{
		*target = reinterpret_cast<ecs::EntityHandle>(entityHandle)->GetTransform().GetLocalScale();
	}
	...
	\return
		None.
	*//******************************************************************/
	static void SetTransformWorldScale(uint64_t entityHandle, Transform::Vec* value)
	{
	...
	\return
		None.
	*//******************************************************************/
	static void GetTransformWorldScale(uint64_t entityHandle, Transform::Vec* target)
	{
		*target = reinterpret_cast<ecs::EntityHandle>(entityHandle)->GetTransform().GetWorldScale();
	}
	...
	\return
		None.
	*//******************************************************************/
	static void SetTransformLocalRotate(uint64_t entityHandle, Transform::Vec value)
	{
	...
	\return
		None.
	*//******************************************************************/
	static void GetTransformLocalRotate(uint64_t entityHandle, Transform::Vec* target)
	{
		*target = reinterpret_cast<ecs::EntityHandle>(entityHandle)->GetTransform().GetLocalRotation();
	}
	...
	\return
		None.
	*//******************************************************************/
	static void SetTransformWorldRotate(uint64_t entityHandle, Transform::Vec value)
	{
	...
	\return
		None.
	*//******************************************************************/
	static void GetTransformWorldRotate(uint64_t entityHandle, Transform::Vec* target)
	{
		*target = reinterpret_cast<ecs::EntityHandle>(entityHandle)->GetTransform().GetWorldRotation();
	}
